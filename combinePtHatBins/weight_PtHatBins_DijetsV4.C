...
void weight_PtHatBins_DijetsV4(const char *infile="input.root", const char *outfile = "output.root",float maxpthat=30., float xSection=1.,bool updateCorrections=true)
{
