...
jet_response_analyzer_x  largeEta_binning_ptRebin.config -input dijet_pp_mergedpthatbins_2013MCV3.root -useweight true -algs ak3PFJetAnalyzer -drmax 0.3 -output jra_hiF_ak3PF_dijet.root
jet_response_analyzer_x  largeEta_binning_ptRebin.config -input dijet_pp_mergedpthatbins_2013MCV3.root -useweight true -algs ak4PFJetAnalyzer -drmax 0.4 -output jra_hiF_ak4PF_dijet.root
jet_response_analyzer_x  largeEta_binning_ptRebin.config -input dijet_pp_mergedpthatbins_2013MCV3.root -useweight true -algs ak5PFJetAnalyzer -drmax 0.5 -output jra_hiF_ak5PF_dijet.root
jet_response_analyzer_x  largeEta_binning_ptRebin.config -input dijet_pp_mergedpthatbins_2013MCV3.root -useweight true -algs ak3CaloJetAnalyzer -drmax 0.3 -output jra_hiF_ak3Calo_dijet.root
jet_response_analyzer_x  largeEta_binning_ptRebin.config -input dijet_pp_mergedpthatbins_2013MCV3.root -useweight true -algs ak4CaloJetAnalyzer -drmax 0.4 -output jra_hiF_ak4Calo_dijet.root
jet_response_analyzer_x  largeEta_binning_ptRebin.config -input dijet_pp_mergedpthatbins_2013MCV3.root -useweight true -algs ak5CaloJetAnalyzer -drmax 0.5 -output jra_hiF_ak5Calo_dijet.root
